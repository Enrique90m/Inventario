    ...
    public partial class Agregar_Producto : Form
    {
        ...
        private void AGREGAR_PRODUCTO_agregar_Click(object sender, EventArgs e)
        {
            ...
            foreach (Control c in this.groupBox1.Controls)
                if (c is TextBox)
                    if (string.IsNullOrWhiteSpace(c.Text) || string.IsNullOrWhiteSpace(c.Text))
                    {
        ...
        private void BuscarAlgoenTabla(string comando)
        {
            ...
            SqlCeConnection PathBD = new SqlCeConnection("Data Source=C:\\Users\\EnriQuE\\Desktop\\Facturacion\\Facturacion\\BaseDeDatos.sdf;Persist Security Info=False;");
            //abre la conexion
            try
            {
        ...
        private void AGREGAR_PRODUCTO_nombre_KeyPress(object sender, KeyPressEventArgs e)
        {
